   ...
   public:
    camera(vec3 lookfrom, vec3 lookat, vec3 vup = vec3(0, 1, 0), f8 vfov = 90,
        ...
        */
        ...
        lower_left_corner = orig - horizon / 2 - vertic / 2 - cam_z * foc_len; // 用于定位渲染时扫描的表面
